...
robot --variable BROWSER:ff --variable NODE_URL:http://${firefox_node}:5555/wd/hub --variable CAPABILITIES:browserName:ff,platform:LINUX --outputdir chrome_results login_tests &
wait
